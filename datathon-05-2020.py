...
path="/Users/coraliecoumes/desktop/hackaton1_WCS_app/images/logo.png"
...
if vue == 'par département':
     ...
     st.markdown(title1, unsafe_allow_html=True)
     path="/Users/coraliecoumes/desktop/hackaton1_WCS_app/images/abstention.png"
     st.image(Image.open(path), use_column_width=True)
     
     title2 = "<h2 style='text-align: center; color: grey;'></br></br>Votes blancs ou nuls</h2>"
     st.markdown(title2, unsafe_allow_html=True)
     path="/Users/coraliecoumes/desktop/hackaton1_WCS_app/images/blanc.png"
     st.image(Image.open(path), use_column_width=True)
